...
**Branch Strategy:** `main` is the stable branch (contains v4.2.0). All PRs should target `main`. Create feature branches from `main`.
...
**Branches:**
- `main` - Stable branch (contains v4.2.0). Default branch on GitHub.
