...
**Branch Strategy:** `main` is the stable branch (contains v4.3.0). All PRs should target `main`. Create feature branches from `main`.
...
**Branches:**
- `main` - Stable branch (contains v4.3.0). Default branch on GitHub.
